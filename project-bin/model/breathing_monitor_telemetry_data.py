...
class BreathingMonitorTelemtryData:
    def __init__(self, spo2_measurement=None, resp_measurement=None, co2_measurement=None, co2_unit='mmHg', etco2_concentration=None, etco2_pressure=None, battery_level=None):
        """
        Caputure data.
        """
